...
public class DateConstant {
    ...
    /** 标准日期格式：yyyy-MM-dd */
    public final static String NORM_DATE_POINT = "yyyy.MM.dd";
    ...
    /** UTC2时间：yyyy-MM-dd'T'HH:mm:ss.SSS'Z' */
    public final static String UTC2 = "yyyy-MM-dd'T'HH:mm:ss.SSS'Z'";
     ...
     * 日期
     */
    public final static String PURE_DATE_HOUR = "yyyy-MM-dd_HH";
}
