...
public class DefaultEchartsFactory extends EchartsFactory {
	...
	@Override
	public AbstractBarCount createBarCount(Map<String, Object> parameters, Class<?> cls) {
		return (AbstractBarCount)getBeanInstance(cls,parameters);
	}
	...
	@Override
	public AbstractDeviceBarStack createDeviceStack(Map<String, Object> parameters, Class<?> cls) {
		return (AbstractDeviceBarStack)getBeanInstance(cls,parameters);
	}
