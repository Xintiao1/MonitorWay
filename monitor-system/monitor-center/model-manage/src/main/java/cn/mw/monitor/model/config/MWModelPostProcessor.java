package cn.mw.monitor.model.config;
...
public class MWModelPostProcessor implements EnvironmentPostProcessor {
    private final Properties customProperties = new Properties();

    @Override
    public void postProcessEnvironment(ConfigurableEnvironment environment, SpringApplication application) {
        Resource resource = new ClassPathResource("model.properties");
