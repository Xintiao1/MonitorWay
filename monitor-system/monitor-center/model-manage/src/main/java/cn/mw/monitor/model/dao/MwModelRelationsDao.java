 ...
 * @date 2022/2/21
 */
public interface MwModelRelationsDao {
    ...
    List<Map> selectAllModelByRelationsExludeOwn(Integer ownModelId);
    ...
    int deleteModelRelationsGroup(DeleteModelRelationGroupParam param);

    int selectModelRelationsNum(Integer relationGroupId);

    List<Map<String, Object>> selectGroupList(QueryGroupListParam param);

    List<RelationGroupDTO> getRelationGroupListInfo(Integer ownModelId);
