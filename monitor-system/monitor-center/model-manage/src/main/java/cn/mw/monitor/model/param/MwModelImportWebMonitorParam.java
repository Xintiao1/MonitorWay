...
public class MwModelImportWebMonitorParam {
    ...
    @ExcelProperty(value = "超时/秒", index = 6)
    ...
    @ApiModelProperty(value = "机构/部门")
    @ExcelProperty(value = "机构/部门", index = 9)
    private String orgs;
    ...
    @ExcelProperty(value = "厂别", index = 11)
    private String modelSystem;

    @ApiModelProperty(value = "领域")
    @ExcelProperty(value = "领域", index = 12)
