...
/**
 * @ClassName MwReportManageTimeToo
 * @Description ToDo
 * @Author gengjb
...
public class MwReportManageTimeToo {
    ...
    public void linkReportDailyDataCache(){
        try {
...
//    @Scheduled(cron = "0 0/5 * * * ?")
    public void linkReportWeeklyDataCache(){
        try {
            String weekData = getWeekData();
            if(StringUtils.isBlank(weekData) || !"星期一".equals(weekData)){
                return;
            }
            //获取上周时间
...
//    @Scheduled(cron = "0 0/5 * * * ?")
    public void linkReportMonthlyDataCache(){
        try {
            boolean isNotFirstMonth = isFirstDayOfMonth();
            if(!isNotFirstMonth){
                return;
            }
            //获取上月时间
...
//    @Scheduled(cron = "0 0/5 * * * ?")
    public void cpuAndMemoryReportDailyDataCache() {
        try {
...
//            int daysOfMonth = getDaysOfMonth(new Date(), 0, -1, 0);
            ...
            for (int i = 0; i < initializeDay; i++){
                ...
                log.info("CPU报表定时任务执行 MwReportManageTimeToo"+days+":::"+trendDay);
                if(days > trendDay){
    ...
    // @Scheduled(cron = "0 0 3 * * ?")
//    @Scheduled(cron = "0 0/5 * * * ?")
    public void cpuAndMemoryReportWeeklyDataCache(){
        try {
            String weekData = getWeekData();
            if(StringUtils.isBlank(weekData) || !"星期一".equals(weekData)){
                return;
    ...
    //  @Scheduled(cron = "0 0 3 * * ?")
//    @Scheduled(cron = "0 0/5 * * * ?")
    public void cpuAndMemoryReportMonthlyDataCache(){
        try {
            boolean isNotFirstMonth = isFirstDayOfMonth();
            if(!isNotFirstMonth){
                return;
...
//    @Scheduled(cron = "0 0/5 * * * ?")
    public void diskUseReportDailyDataCache(){
        try {
...
//            int daysOfMonth = getDaysOfMonth(new Date(), 0, -1, 0);
    ...
    // @Scheduled(cron = "0 0 3 * * ?")
//    @Scheduled(cron = "0 0/5 * * * ?")
    public void diskUseReportWeeklyDataCache(){
        try {
            String weekData = getWeekData();
            if(StringUtils.isBlank(weekData) || !"星期一".equals(weekData)){
                return;
    ...
    // @Scheduled(cron = "0 0 3 * * ?")
//    @Scheduled(cron = "0 0/5 * * * ?")
    public void diskUseReportMonthlyDataCache(){
        try {
            boolean isNotFirstMonth = isFirstDayOfMonth();
            if(!isNotFirstMonth){
                return;
...
//    @Scheduled(cron = "0 0/5 * * * ?")
    public void assetUsabilityReportDailyDataCache() {
        try {
...
//    @Scheduled(cron = "0 0/5 * * * ?")
    public void assetUsabilityReportWeeklyDataCache(){
        try {
            String weekData = getWeekData();
            if(StringUtils.isBlank(weekData) || !"星期一".equals(weekData)){
                return;
    ...
    //   @Scheduled(cron = "0 10 5 * * ?")
//    @Scheduled(cron = "0 0/5 * * * ?")
    public void assetUsabilityReportMonthlyDataCache(){
        try {
            boolean isNotFirstMonth = isFirstDayOfMonth();
            if(!isNotFirstMonth){
                return;
    ...
    // @Scheduled(cron = "* 01 2 * * ?")
//    @Scheduled(cron = "0 0/5 * * * ?")
    public void runStateReportDailyDataCache() {
...
//    @Scheduled(cron = "0 0/5 * * * ?")
    public void runStateReportWeeklyDataCache(){
        try {
            String weekData = getWeekData();
            if(StringUtils.isBlank(weekData) || !"星期一".equals(weekData)){
                return;
    ...
    //  @Scheduled(cron = "0 30 5 * * ?")
//    @Scheduled(cron = "0 0/5 * * * ?")
    public void runStateReportMonthlyDataCache(){
        try {
            boolean isNotFirstMonth = isFirstDayOfMonth();
            if(!isNotFirstMonth){
                return;
    ...
    //   @Scheduled(cron = "0 30 5 * * ?")
//    @Scheduled(cron = "0 0/5 * * * ?")
    public void mplsHistoryReportDailyDataCache(){
        try {
...
//            int daysOfMonth = getDaysOfMonth(new Date(), 0, -1, 0);
    ...
    //  @Scheduled(cron = "0 10 3 * * ?")
//    @Scheduled(cron = "0 0/5 * * * ?")
    public void mplsHistoryReportWeeklyDataCache(){
        try {
            String weekData = getWeekData();
            if(StringUtils.isBlank(weekData) || !"星期一".equals(weekData)){
                return;
    ...
    //   @Scheduled(cron = "0 30 3 * * ?")
//    @Scheduled(cron = "0 0/5 * * * ?")
    public void mplsHistoryReportMonthlyDataCache(){
        try {
            boolean isNotFirstMonth = isFirstDayOfMonth();
            if(!isNotFirstMonth){
                return;
        ...
        try {
            ...
            if (!CollectionUtils.isEmpty(cacheDatas)) {
                ...
                if(!CollectionUtils.isEmpty(cacheDatas)){
                    ...
                    log.info("线路流量今日数据缓存:"+newList.size());
                    if(!CollectionUtils.isEmpty(newList)){
                        terraceManageDao.saveLinkFlowCacheData(newList);
                    }
                }
