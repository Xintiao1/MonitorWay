package cn.mw.monitor.ipaddressmanage.config;
...
public class MWIpManagePostProcessor implements EnvironmentPostProcessor {

    private final Properties customProperties = new Properties();

    @Override
    public void postProcessEnvironment(ConfigurableEnvironment environment, SpringApplication application) {
        Resource resource = new ClassPathResource("ipmanage.properties");
