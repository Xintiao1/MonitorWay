package cn.mw.monitor.logManage.utils;

import cn.mw.monitor.api.common.Constants;
import cn.mw.monitor.api.common.ResponseBase;
import cn.mw.monitor.logManage.exception.LogManageBusinessException;
...
public class OkHttpUtils {
    ...
    public static ResponseBase getResultObject(String result) {
        ...
        if (Constants.HTTP_RES_CODE_200.equals(rtnCode)) {
            ...
            return new ResponseBase(Constants.HTTP_RES_CODE_500, message, null);
        }
    }
